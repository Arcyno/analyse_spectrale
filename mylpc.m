function [lpc_frames, sigma_frames] = mylpc(f_ech,son,frames_length,ordre);
...
for frame = 1: Nframes           %###########################################################%
    ...
    acf = xcorr(son_fen, ordre+1, 'biased'); %% autocorr\'elation
